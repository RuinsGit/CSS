...
@section('title', 'Xidmət Kateqoriyası Redaktə')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Xidmət Kateqoriyası Redaktə</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Ana səhifə</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('back.pages.service-categories.index') }}">Xidmət Kateqoriyaları</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.service-categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        @if($category->image)
                                                            <div class="mb-2">
                                                                <img src="{{ asset($category->image) }}" alt="{{ $category->title_az }}" class="img-thumbnail" style="max-height: 200px">
                                                            </div>
                                                        @endif
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_az') is-invalid @enderror" id="title_az" name="title_az" value="{{ old('title_az', $category->title_az) }}" required>
                                                        @error('title_az')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_az') is-invalid @enderror" id="description_az" name="description_az" rows="5">{{ old('description_az', $category->description_az) }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $category->title_en) }}">
                                                        @error('title_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="5">{{ old('description_en', $category->description_en) }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_ru') is-invalid @enderror" id="title_ru" name="title_ru" value="{{ old('title_ru', $category->title_ru) }}">
                                                        @error('title_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_ru') is-invalid @enderror" id="description_ru" name="description_ru" rows="5">{{ old('description_ru', $category->description_ru) }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('back.pages.service-categories.index') }}" class="btn btn-secondary">
