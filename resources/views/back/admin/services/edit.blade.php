        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Xidmət Redaktə</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Ana səhifə</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('back.pages.services.index') }}">Xidmətlər</a></li>
                        ...
                        <form action="{{ route('back.pages.services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane active" id="basic_info" role="tabpanel">
                                    <div class="row">
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        @if($service->image)
                                                            <div class="mb-2">
                                                                <img src="{{ asset($service->image) }}" alt="{{ $service->title_az }}" class="img-thumbnail" style="max-height: 200px">
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="mb-3 mt-4">
                                                        ...
                                                        @if($service->icon)
                                                            <div class="mb-2">
                                                                <img src="{{ asset($service->icon) }}" alt="İkon" class="img-thumbnail" style="max-height: 64px; max-width: 64px;">
                                                            </div>
                                                        @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border shadow-none mb-4">
                                                <div class="card-header bg-light">
                                                    <h5 class="card-title mb-0">SEO və Status</h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label for="service_category_id" class="form-label">Kateqoriya</label>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-text">Boş buraxsanız, başlıqdan avtomatik yaradılacaq</div>
                                                        @error('slug')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-check form-switch form-switch-success mb-3">
                                                        <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" {{ old('status', $service->status) ? 'checked' : '' }}>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_az') is-invalid @enderror" id="title_az" name="title_az" value="{{ old('title_az', $service->title_az) }}" required>
                                                        @error('title_az')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_az') is-invalid @enderror" id="description_az" name="description_az" rows="5" required>{{ old('description_az', $service->description_az) }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $service->title_en) }}">
                                                        @error('title_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="5">{{ old('description_en', $service->description_en) }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_ru') is-invalid @enderror" id="title_ru" name="title_ru" value="{{ old('title_ru', $service->title_ru) }}">
                                                        @error('title_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_ru') is-invalid @enderror" id="description_ru" name="description_ru" rows="5">{{ old('description_ru', $service->description_ru) }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('back.pages.services.index') }}" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        // Başlıqdan slug yaratma
        $('#title_az').keyup(function() {
            if (!$('#slug').val()) {
                var slug = $(this).val()
                    .toLowerCase()
                    .replace(/[^\w ]+/g, '')
